...
`PLANO-SSCAD2026-HIBRIDO.md` is the working plan that drove this campaign,
moved here from the workspace root so it sits with the data it describes. Read it
for the measured numbers and the "what we do and don't claim" decisions, not as a
current plan.
